...
const scrubberSlice = createSlice({
  ...
  reducers: {
    ...
    setCurrentScrubberFrame(
      state,
      action: PayloadAction<CurrentScrubberFrame>
    ) {
...
export const { setScrubberCanvasWidth, setCurrentScrubberFrame } =
  scrubberSlice.actions;

export type SetCurrentScrubberFrame = ReturnType<
  typeof setCurrentScrubberFrame
>;
